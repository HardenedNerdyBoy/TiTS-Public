package classes.Items.Drinks
{
	...
	public class RaskvelBroodmotherMilkBucket_Small extends ItemSlotClass
	{
		...
		//constructor
		public function RaskvelBroodmotherMilkBucket_Small()
		{
			...
			this.shortName = "Small B.Milk Bucket";
			//Regular name
			this.longName = "Small Broodmother milk bucket x" + this.quantity;
			
			TooltipManager.addFullName(this.shortName, StringUtil.toTitleCase(this.longName));
			
			//Longass shit, not sure what used for yet.
			this.description = "a partially-full bucket of raskvel broodmother udder milk";
			//Displayed on tooltips during mouseovers
			this.tooltip = "A big, bucket partially-full of the Raskvel Broodmothers udder milk. While not as fresh as it'd be from her big pink nipples, her motherly milk still tastes pretty good.";
